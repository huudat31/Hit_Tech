class HttpMessage {
  ...
  static const String errNoInternetConnection = 'Không có kết nối internet. Vui lòng kiểm tra lại.';
  static const String errServer = 'Máy chủ gặp sự cố. Vui lòng thử lại sau.';
  static const String errBadRequest = 'Yêu cầu không hợp lệ. Vui lòng kiểm tra lại thông tin.';
  static const String errUnauthorized = 'Bạn chưa đăng nhập hoặc phiên đăng nhập đã hết hạn.';
  static const String errForbidden = 'Bạn không có quyền truy cập chức năng này.';
  static const String errNotFound = 'Không tìm thấy dữ liệu yêu cầu.';
  static const String errConflict = 'Dữ liệu đã tồn tại.';
  static const String errTooManyRequest = 'Bạn đã gửi quá nhiều yêu cầu. Vui lòng chờ một lúc.';
}

class ValidationMessage {
  // Error message
  static const String errInvalidSomethingField = 'Trường không hợp lệ.';
  static const String errInvalidFormatSomeThingField = 'Định dạng trường không hợp lệ.';
  static const String errInvalidSomethingFieldIsRequired = 'Trường này là bắt buộc.';
  static const String errInvalidFormatPassword = 'Mật khẩu phải chứa ít nhất 1 chữ hoa, 1 chữ thường, 1 số và 1 ký tự đặc biệt.';
  ...
  static const String errReEnterPasswordNotMatch = 'Mật khẩu nhập lại không khớp.';
  static const String errDuplicateOldPassword = 'Mật khẩu mới không được trùng mật khẩu cũ.';
}
...
class AuthMessage {
  ...
  static const String errLoginFail = 'Đăng nhập thất bại. Vui lòng kiểm tra lại.';
  static const String errRegisterFail = 'Đăng ký thất bại. Vui lòng thử lại.';

  static const String errOtpExpiredOrNotFound = 'OTP đã hết hạn hoặc không tồn tại.';
...
class UserMessage {
  ...
  static const String errAccountRecoveryExpired = 'Thời gian khôi phục tài khoản đã hết.';
  static const String errAccountNotDeleted = 'Tài khoản chưa bị xóa.';

  static const String errIncorrectPasswordConfirmation = 'Xác nhận mật khẩu không đúng.';
  static const String errPersonalInformationNotCompleted = 'Thông tin cá nhân chưa được hoàn tất.';
  ...
  static const String sucFillPersonalInformation = 'Điền thông tin cá nhân thành công.';
}

class UserHealthMessage {
  // Error message
  static const String errUserHealthNotFound = 'Không tìm thấy thông tin sức khỏe người dùng.';
  static const String errGenderRequired = 'Vui lòng chọn giới tính.';
  static const String errActivityLevelRequired = 'Vui lòng chọn mức độ hoạt động.';
  ...
  // Success message
  static const String sucFillPersonalHealth = 'Cập nhật thông tin sức khỏe thành công.';
}

class TrainingFlowMessage {
  // Error message
  static const String errSomethingWrong = 'Đã xảy ra lỗi trong quá trình thiết lập kế hoạch luyện tập.';

  // Success message
  static const String sucTrainingFlow = 'Thiết lập kế hoạch luyện tập thành công.';
  static const String sucTrainingReset = 'Đặt lại kế hoạch luyện tập thành công.';
}

class TrainingMessage {
  // Error message
  static const String errExerciseNotExisted = 'Bài tập không tồn tại.';
  static const String errTrainingPlanNotExisted = 'Kế hoạch luyện tập không tồn tại.';
